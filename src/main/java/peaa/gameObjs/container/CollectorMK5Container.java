...
public class CollectorMK5Container extends Container
{
	private CollectorMK5Tile tile;
	private int sunLevel;

	public CollectorMK5Container(InventoryPlayer invPlayer, CollectorMK5Tile collector) {
		this.tile = collector;
		tile.openInventory();
